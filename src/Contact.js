...
import imageUpWorkBlue from './images/upwork.png'
import imageUpWork from './images/upwork1.svg'
      ...
      <div
        ...
        <div className="nav_socialMedia_edging">
          <a
            ...
            href="https://linkedin.com/in/oleksandr-yuzefovych-a3644b281">
            <svg
              className="nav_socialMedia_link_svg"
              stroke="#5271ff"
              fill="#5271ff"
        ...
        <div className="nav_socialMedia_edging">
          <a class="nav_socialMedia_link" href="https://t.me/yuzefovych_alex">
            <svg
              className="nav_socialMedia_link_svg"
              stroke="#5271ff"
              fill="#5271ff"
        ...
        <div className="nav_socialMedia_edging">
          <a class="nav_socialMedia_link" href="https://www.upwork.com/freelancers/~015422e28fba09bc65">
            <img className='nav_socialMedia_link_img1' src={imageUpWorkBlue}/>
            <img className='nav_socialMedia_link_img2' src={imageUpWork}/>
          </a>
        </div>
      ...
      <dir className="details">
        <div
          ...
          <p className="details_text">
            If you want to know my location or contact me, you can use these
            details.
          </p>
        </div>
